...
public class PdfService {
    ...
    public Document exportFlightTicket(HttpServletResponse response, Integer flightReservationId) throws IOException{
        ...
        //Fonts
        Font font30 = FontFactory.getFont(FontFactory.HELVETICA_BOLD);
        font30.setSize(30);
        font30.setColor(Color.getHSBColor(97,86,95));
        ...
        Paragraph reservationConfirmation = new Paragraph("Reserva Confirmada",font30);
