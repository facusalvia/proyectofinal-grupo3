...
public class FlightEntityFactory {
    ...
    public static FlightEntity newFlightEntity(){
        ...
        return new FlightEntity(1,"TEST-FLIGHT", LocalDate.of(2022,06,02),
                LocalDate.of(2022,06,10),2520,"Solano","Florencio Varela",
                "Prestige",flightReservationEntityList);
    }
    public static FlightDTO newFlightDTO(){
        return new FlightDTO("TEST-FLIGHT", LocalDate.of(2022,06,02),
                LocalDate.of(2022,06,10),2520,"Solano","Florencio Varela",
                "Prestige");
    }
